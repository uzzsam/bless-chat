"use strict";var BlessChat=(()=>{var E=Object.defineProperty;var P=Object.getOwnPropertyDescriptor;var U=Object.getOwnPropertyNames;var D=Object.prototype.hasOwnProperty;var W=(a,e)=>{for(var s in e)E(a,s,{get:e[s],enumerable:!0})},Y=(a,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of U(e))!D.call(a,n)&&n!==s&&E(a,n,{get:()=>e[n],enumerable:!(t=P(e,n))||t.enumerable});return a};var z=a=>Y(E({},"__esModule",{value:!0}),a);var ee={};W(ee,{mount:()=>y});var f={apiUrl:"https://bless-test-brown.vercel.app/api/chat",placeholder:"Talk to Sidthah",sendAriaLabel:"Send message",loadingText:"Listening...",requireBlessing:!0};function u(a){if(a==null)return;let e=a.toString().trim();if(!e)return;let s=e.toLowerCase();if(!(s==="undefined"||s==="null"))return e}function K(a){if(a==null)return;let e=a.toString().trim().toLowerCase();if(!e)return!0;if(["false","0","no","off","disabled"].includes(e))return!1;if(["true","1","yes","on","enabled"].includes(e))return!0}var j=`
:root {
...
</svg>`}var S="bless-chat-blessing-created",F=[/Thank you for (sharing|uploading|providing).*?(files?|documents?|that)!?.*$/gim,/How can I assist you with (them|it|the files?)\?.*$/gim,/Would you like me to search for specific information.*$/gim,/or summarize the content\?.*$/gim,/\【\d+:\d+†source\】/g,/To create a personalized blessing.*?providing the files?!?/gim,/and for providing the files?!?/gim];function L(a){let e=a!=null?a:"";return F.forEach(s=>{e=e.replace(s,"")}),e.trim()}function G(a){try{return typeof sessionStorage!="undefined"?sessionStorage.getItem(a):null}catch{return null}}function C(a,e){try{typeof sessionStorage!="undefined"&&sessionStorage.setItem(a,e)}catch{}}function J(a){let e=["[data-bless-panel]",".bless-blessing__panel","#bless-blessing__panel"].join(",");document.querySelectorAll(e).forEach(s=>{s.style.fontFamily="'Cormorant Upright', serif",s.style.whiteSpace="pre-line",s.style.textAlign="center",s.style.color="#fff",s.style.fontSize="clamp(18px, 2.4vw, 30px)",s.style.lineHeight="1.35",s.style.textShadow="0 2px 8px rgba(0,0,0,.55)",s.textContent=a})}function N(a){if(!a)return null;let e=a.replace(/([*\-•]?\s*)([1-7])[\.\)\:]\s*/g,`
$2. `).replace(/\s{2,}/g," ").trim(),s=e.split(/\r?\n/).map(o=>o.trim()).filter(Boolean);if(s.filter(o=>/^[1-7]\.\s*/.test(o)).length<7)return null;let i=s.filter(o=>!/^[1-7]\.\s*/.test(o)).join(" ").trim();if(!v.every(o=>e.toLowerCase().includes(o.label.toLowerCase())||e.includes(`(${o.key})`)))return null;let l=v.map(o=>`${o.label} (${o.key})`);return{intro:i,options:l,metas:v}}function V(a){if(!a)return null;let e=a.match(/\(([A-Za-z]+)\)\s*$/);if(e){let t=O(e[1]);if(t)return t}let s=a.replace(/\([^)]*\)/g,"").trim();return H(s)}var A=class{constructor(e,s){this.messages=[];this.isProcessing=!1;this.blessingDelivered=!1;this.currentStreamingNode=null;this.currentStreamingText="";this.activeSidthie=null;this.lastExplanation="";this.pendingBlessing=null;this.pendingBlessingMeta=null;this.collectedEmail=null;this.awaitingEmail=!1;this.N8N_WEBHOOK_URL="https://n8n.theexperiencen8n.top/webhook/951bd832-961c-4f19-a263-96632039cd07";this.THANK_YOU_PAGE="/pages/blessing-thank-you";this.blessingCount=0;this.MAX_BLESSINGS=3;this.STORAGE_KEY="bless-chat-session-count";var n,i,r,l;this.container=e;let t={...f,...s||{}};this.options={apiUrl:(n=u(t.apiUrl))!=null?n:f.apiUrl,placeholder:(i=u(t.placeholder))!=null?i:f.placeholder,sendAriaLabel:(r=u(t.sendAriaLabel))!=null?r:f.sendAriaLabel,loadingText:(l=u(t.loadingText))!=null?l:f.loadingText,requireBlessing:t.requireBlessing},this.blessingDelivered=G(S)==="true",this.blessingCount=this.getBlessingCount(),!this.options.requireBlessing&&this.blessingDelivered&&(this.blessingDelivered=!1)}getBlessingCount(){try{let e=sessionStorage.getItem(this.STORAGE_KEY);return e?parseInt(e,10):0}catch{return 0}}incrementBlessingCount(){this.blessingCount+=1;try{sessionStorage.setItem(this.STORAGE_KEY,this.blessingCount.toString())}catch{}}hasReachedLimit(){return this.blessingCount>=this.MAX_BLESSINGS}showLimitReached(){this.pushAssistantMessage(`Three blessings daily allows each to settle deeply. You have received ${this.blessingCount} blessing${this.blessingCount>1?"s":""} this session. Close your browser to begin a new session, or return tomorrow for fresh blessings.`),this.inputEl.disabled=!0,this.sendBtn.disabled=!0}mount(){let e=u(this.container.dataset.chatWidth);e&&this.container.style.setProperty("--bless-chat-max-width",e);let s=u(this.container.dataset.chatRadius);s&&this.container.style.setProperty("--bless-chat-radius",s),this.container.innerHTML="",this.container.classList.add("bless-chat-shell");let t=document.createElement("div");t.className="bless-chat-window",this.messageList=document.createElement("div"),this.messageList.className="bless-chat-messages",this.statusEl=document.createElement("div"),this.statusEl.className="bless-chat-bubble bless-chat-bubble--status",this.statusEl.hidden=!0,this.errorEl=document.createElement("div"),this.errorEl.className="bless-chat-error",this.errorEl.hidden=!0;let n=document.createElement("form");n.className="bless-chat-input-row";let i=document.createElement("div");i.className="bless-chat-input-wrapper",this.inputEl=document.createElement("input"),this.inputEl.type="text",this.inputEl.className="bless-chat-input",this.inputEl.placeholder=this.options.placeholder,this.inputEl.autocomplete="off",this.inputEl.spellcheck=!1,this.inputEl.setAttribute("aria-label",this.options.placeholder),i.appendChild(this.inputEl),this.sendBtn=document.createElement("button"),this.sendBtn.type="submit",this.sendBtn.className="bless-chat-send",this.sendBtn.setAttribute("aria-label",this.options.sendAriaLabel),this.sendBtn.innerHTML=$(),n.append(i,this.sendBtn),n.addEventListener("submit",r=>{r.preventDefault(),this.handleSubmit()}),this.messageList.addEventListener("scroll",()=>{this.messageList.scrollTop===0?this.messageList.classList.add("scrolled-top"):this.messageList.classList.remove("scrolled-top")}),t.append(this.messageList,this.statusEl,n,this.errorEl),this.container.appendChild(t),this.inputEl.addEventListener("keydown",r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),this.handleSubmit())}),this.blessingDelivered&&this.options.requireBlessing?this.pushAssistantMessage("Your blessing has already been crafted. Scroll to revisit it below."):this.hasReachedLimit()?this.showLimitReached():(this.options.requireBlessing||C(S,"false"),this.startConversation())}async startConversation(){this.activeSidthie=null,this.lastExplanation="",await this.fetchAssistantReply()}async handleSubmit(){if(this.isProcessing)return;let e=this.inputEl.value.trim();if(!e){this.inputEl.reportValidity();return}if(this.blessingDelivered&&this.options.requireBlessing){this.pushAssistantMessage("Your blessing has been created. Scroll down to read it."),this.inputEl.value="";return}this.appendMessage({role:"user",content:e}),this.inputEl.value="",this.messages.push({role:"user",content:e}),await this.fetchAssistantReply()}appendMessage(e,s=!1){if(e.role==="assistant"&&!s){this.captureExplanation(e.content);let n=N(e.content);if(n){this.messages.push({role:"assistant",content:e.content}),this.createOptionsBubble(n.options,n.intro,n.metas);return}}let t=document.createElement("div");t.className="bless-chat-bubble",e.role==="user"&&t.classList.add("bless-chat-bubble--user"),t.textContent=e.content,this.messageList.appendChild(t),this.scrollToBottom(),e.role==="assistant"&&s&&(t.classList.add("bless-chat-bubble--streaming"),this.currentStreamingNode=t,this.currentStreamingText=e.content)}captureExplanation(e){if(!e)return;let s=e.split(`

`);if(s.length>0){let t=s[0].trim();t.length>30&&t.length<300&&(this.lastExplanation=t)}}createOptionsBubble(e,s,t){if(this.activeSidthie=null,s){let r=document.createElement("div");r.className="bless-chat-bubble",r.textContent=s,this.messageList.appendChild(r),this.scrollToBottom()}let n=document.createElement("div");n.className="bless-chat-bubble";let i=document.createElement("div");i.className="bless-chat-options",e.forEach((r,l)=>{let o=document.createElement("button");o.type="button",o.className="bless-chat-option",o.textContent=r,o.addEventListener("click",()=>{var h;let c=(h=t==null?void 0:t[l])!=null?h:V(r);if(c){this.activeSidthie=c;try{window.dispatchEvent(new CustomEvent("sidthie:selected",{detail:{sidthie:c.key,sidthieLabel:c.label}}))}catch{}}this.appendMessage({role:"user",content:r}),this.messages.push({role:"user",content:r}),i.querySelectorAll("button").forEach(p=>{p.disabled=!0}),this.fetchAssistantReply()}),i.appendChild(o)}),n.appendChild(i),this.messageList.appendChild(n),this.scrollToBottom()}updateStreamingBubble(e){this.currentStreamingNode&&(this.currentStreamingText+=e,this.currentStreamingNode.textContent=this.currentStreamingText,this.scrollToBottom())}finalizeStreamingBubble(e){if(this.currentStreamingNode){this.currentStreamingNode.classList.remove("bless-chat-bubble--streaming");let s=N(e);if(s){this.messageList.removeChild(this.currentStreamingNode),this.currentStreamingNode=null,this.currentStreamingText="",this.createOptionsBubble(s.options,s.intro);return}this.currentStreamingNode.textContent=e.trim()}this.currentStreamingNode=null,this.currentStreamingText="",this.scrollToBottom()}pushAssistantMessage(e){let s={role:"assistant",content:e};this.appendMessage(s),this.messages.push(s)}setStatus(e,s=!1){e?(s?(this.statusEl.innerHTML='<span class="bless-typing" aria-hidden="true"><span></span><span></span><span></span></span>',this.statusEl.classList.add("is-typing"),this.statusEl.setAttribute("aria-label",e)):(this.statusEl.textContent=e,this.statusEl.classList.remove("is-typing"),this.statusEl.removeAttribute("aria-label")),this.statusEl.hidden=!1):(this.statusEl.hidden=!0,this.statusEl.classList.remove("is-typing"),this.statusEl.innerHTML="",this.statusEl.removeAttribute("aria-label"))}setError(e){e?(this.errorEl.textContent=e,this.errorEl.hidden=!1):(this.errorEl.hidden=!0,this.errorEl.textContent="")}scrollToBottom(){requestAnimationFrame(()=>{this.messageList.scrollTop=this.messageList.scrollHeight})}showRetryButton(){let e=document.createElement("button");e.type="button",e.className="bless-chat-retry",e.textContent="Try again",e.addEventListener("click",()=>{e.remove(),this.fetchAssistantReply()}),this.messageList.appendChild(e),this.scrollToBottom()}async fetchAssistantReply(){this.isProcessing=!0,this.sendBtn.disabled=!0,this.setError(),this.setStatus(this.options.loadingText,!0);let e=new AbortController,s=setTimeout(()=>e.abort(),3e4);try{let t=await fetch(this.options.apiUrl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:this.messages}),signal:e.signal});if(clearTimeout(s),!t.ok){let n=await X(t);throw new Error((n==null?void 0:n.error)||`Request failed with status ${t.status}`)}if(Z(t))await this.handleStream(t);else{let n=await t.json(),i=(n==null?void 0:n.message)||"",r=!!(n!=null&&n.done);if(i){let o=L(i)||i;this.appendMessage({role:"assistant",content:o}),this.messages.push({role:"assistant",content:o}),this.onAssistantComplete(o,r),this.setStatus()}}}catch(t){clearTimeout(s),console.error("Bless chat error",t);let n="Something went wrong. Please try again.";t.name==="AbortError"?n="The response took too long. Let us try once more.":t!=null&&t.message&&(n=t.message),this.setError(n),this.showRetryButton()}finally{this.setStatus(),this.isProcessing=!1,this.sendBtn.disabled=!1}}recordStateMarker(e){if(!(e!=null&&e.marker))return;let s=e.marker.trim();s&&this.messages.push({role:"assistant",content:s})}async handleStream(e){var p,b,m,B,T;let s=(p=e.body)==null?void 0:p.getReader();if(!s){let w=await e.text();this.pushAssistantMessage(w);return}let t=!1,n="",i=null;this.appendMessage({role:"assistant",content:""},!0);let r=new TextDecoder,l="";for(;;){let{value:w,done:q}=await s.read();if(q)break;l+=r.decode(w,{stream:!0});let k=l.split(`

`);l=k.pop()||"";for(let _ of k){let I=_.split(`
`),g="";for(let x of I)x.startsWith("data:")&&(g+=x.slice(5).trim());if(!g||g==="[DONE]")continue;let d;try{d=JSON.parse(g)}catch{console.warn("Unable to parse stream chunk",g);continue}if(d.type==="delta"&&typeof d.textDelta=="string")n+=d.textDelta,this.updateStreamingBubble(d.textDelta);else if(d.type==="done")i=d.meta||null,i&&typeof i.done=="boolean"?t=i.done:(i==null?void 0:i.state)==="compose_blessing"&&(t=!0),!n&&typeof d.text=="string"&&(n=d.text);else if(d.type==="meta")typeof d.done=="boolean"&&(t=d.done),d.marker&&(i=i!=null?i:{},i.marker||(i.marker=d.marker)),i||(i={state:d.state,sidthieKey:(b=d.sidthieKey)!=null?b:null,sidthieLabel:(m=d.sidthieLabel)!=null?m:null,userName:(B=d.userName)!=null?B:null,marker:(T=d.marker)!=null?T:null,done:d.done});else if(d.type==="error")throw new Error(d.message||"Unexpected error")}}let o=n.trim(),h=L(o)||o;this.finalizeStreamingBubble(h),this.messages.push({role:"assistant",content:h}),this.recordStateMarker(i||void 0),this.onAssistantComplete(h,t,i||void 0)}onAssistantComplete(e,s,t){if(e){if(s){this.incrementBlessingCount();let n=this.prepareBlessing(e),i=n.blessing||n.raw||e.trim();this.pendingBlessing=i,this.pendingBlessingMeta=t||null;let r=this.messageList.lastElementChild;r&&r.classList.contains("bless-chat-bubble")&&this.messageList.removeChild(r),this.showBlessingPreviewAndAskEmail(i,t);return}/image|upload|photo|picture/i.test(e)&&this.pushAssistantMessage("No image is needed. Let us continue in words.")}}extractBlessingPreview(e){let s=e.split(/[.!?]+/).filter(n=>n.trim().length>0);if(!s.length)return e.slice(0,150);let t=s[0].trim();return t.length<80&&s.length>1&&(t+=". "+s[1].trim()),t.length>150&&(t=t.slice(0,147)+"..."),t}showBlessingPreviewAndAskEmail(e,s){let t=this.extractBlessingPreview(e),n=document.createElement("div");n.className="bless-chat-bubble bless-chat-preview bless-chat-preview--truncated",n.textContent=t+"...",this.messageList.appendChild(n),this.scrollToBottom(),this.awaitingEmail=!0,this.inputEl.disabled=!0,this.sendBtn.disabled=!0,setTimeout(()=>{this.pushAssistantMessage("What's your email so I can send you the complete blessing?"),this.createEmailInputBubble()},800)}createEmailInputBubble(){let e=document.createElement("div");e.className="bless-chat-bubble bless-chat-email-bubble";let s=document.createElement("form");s.className="bless-chat-email-form";let t=document.createElement("div");t.className="bless-chat-email-wrapper";let n=document.createElement("input");n.type="email",n.className="bless-chat-email-input",n.placeholder="Enter your email",n.required=!0,n.autocomplete="email";let i=document.createElement("button");i.type="submit",i.className="bless-chat-email-submit",i.textContent="Receive blessing";let r=document.createElement("div");r.className="bless-chat-email-error",r.hidden=!0,t.appendChild(n),t.appendChild(i),s.appendChild(t),s.appendChild(r),e.appendChild(s),s.addEventListener("submit",async l=>{l.preventDefault();let o=n.value.trim();if(!this.validateEmail(o)){r.textContent="Please enter a valid email address",r.hidden=!1,n.focus();return}r.hidden=!0,n.disabled=!0,i.disabled=!0,i.textContent="Saving...",await this.handleEmailSubmission(o)}),this.messageList.appendChild(e),this.scrollToBottom(),n.focus()}validateEmail(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}async handleEmailSubmission(e){if(!this.pendingBlessing){this.pushAssistantMessage("Something went wrong. Please refresh and try again.");return}try{if(!await this.sendToN8N(e,this.pendingBlessing,this.pendingBlessingMeta||void 0))throw new Error("Webhook failed");this.collectedEmail=e,this.blessingDelivered=!0,C(S,"true"),this.displayBlessing(this.pendingBlessing,this.pendingBlessingMeta||void 0),this.pushAssistantMessage("Perfect! Your blessing has been sent to "+e),setTimeout(()=>{let t=document.querySelector("[data-bless-panel], .bless-blessing__panel, #bless-blessing__panel");t&&t.scrollIntoView({behavior:"smooth",block:"start"})},500),setTimeout(()=>{this.showContinueButton(e)},2e3)}catch(s){console.error("Email submission error:",s);let t=document.createElement("div");t.className="bless-chat-bubble bless-chat-error-bubble",t.textContent="We couldn't save your blessing right now. ";let n=document.createElement("button");n.type="button",n.className="bless-chat-retry",n.textContent="Try again",n.addEventListener("click",()=>{t.remove(),this.createEmailInputBubble()}),t.appendChild(n),this.messageList.appendChild(t),this.scrollToBottom()}}async sendToN8N(e,s,t){let n={email:e,userName:(t==null?void 0:t.userName)||null,blessedPersonName:(t==null?void 0:t.userName)||null,chosenSidthie:(t==null?void 0:t.sidthieKey)||null,sidthieLabel:(t==null?void 0:t.sidthieLabel)||null,blessingText:s,explanation:this.lastExplanation||null,timestamp:new Date().toISOString()};try{let i=new AbortController,r=setTimeout(()=>i.abort(),3e4),l=await fetch(this.N8N_WEBHOOK_URL,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n),signal:i.signal});return clearTimeout(r),l.ok?!0:(console.error("N8N webhook failed:",l.status,l.statusText),!1)}catch(i){return i.name==="AbortError"?console.error("N8N webhook timeout"):console.error("N8N webhook error:",i),!1}}showContinueButton(e){var c,h;let s=((c=this.pendingBlessingMeta)==null?void 0:c.userName)||null,t=((h=this.pendingBlessingMeta)==null?void 0:h.sidthieKey)||null,n=document.createElement("div");n.className="bless-chat-bubble bless-chat-continue-bubble";let i=document.createElement("button");i.type="button",i.className="bless-chat-continue-button",i.textContent="Continue your journey";let r=null,l=30,o=()=>{r&&clearTimeout(r),this.redirectToThankYou(s||void 0,t||void 0)};i.addEventListener("click",o),n.appendChild(i),this.messageList.appendChild(n),this.scrollToBottom(),r=setTimeout(()=>{o()},3e4)}redirectToThankYou(e,s){if(this.pendingBlessing)try{sessionStorage.setItem("bless-blessing-text",this.pendingBlessing),s&&sessionStorage.setItem("bless-sidthie-key",s)}catch{}let t=new URLSearchParams;e&&t.append("name",e),s&&t.append("sidthie",s);let n=`${this.THANK_YOU_PAGE}${t.toString()?"?"+t.toString():""}`;window.location.href=n}prepareBlessing(e){let s=L(e),t=s.split(/\r?\n/).map(r=>r.trim()).filter(Boolean),n=[],i=[];for(let r of t)n.length<5&&!/^is the blessing/i.test(r)?n.push(r):/^is the blessing/i.test(r)||i.push(r);return{blessing:n.join(`
`),extra:i,raw:s}}displayBlessing(e,s){var r;let t=this.activeSidthie;!t&&(s!=null&&s.sidthieKey)&&(t=O(s.sidthieKey),t&&(this.activeSidthie=t)),!t&&(s!=null&&s.sidthieLabel)&&(t=H(s.sidthieLabel),t&&(this.activeSidthie=t));let n=this.lastExplanation||(t==null?void 0:t.description)||(t==null?void 0:t.short)||"";try{J(e)}catch{}let i={text:e,blessing:e,sidthie:(t==null?void 0:t.key)||null,sidthieLabel:(t==null?void 0:t.label)||null,explanation:n,emailCollected:!0};if(this.renderBlessingPanel({blessing:e,explanation:n,sidthieLabel:(r=i.sidthieLabel)!=null?r:void 0}),t)try{window.dispatchEvent(new CustomEvent("sidthie:selected",{detail:{sidthie:t.key,sidthieLabel:t.label}}))}catch{}window.dispatchEvent(new CustomEvent("blessing:ready",{detail:i})),window.dispatchEvent(new CustomEvent("blessing:update",{detail:i})),setTimeout(()=>{this.scrollToBottom();let l=document.querySelector("[data-bless-panel], .bless-blessing__panel, #bless-blessing__panel");l&&l.scrollIntoView({behavior:"smooth",block:"start"})},300)}renderBlessingPanel(e){let s=["[data-bless-panel]",".bless-blessing__panel","#bless-blessing__panel"].join(",");document.querySelectorAll(s).forEach(t=>{t.style.fontFamily="'Cormorant Upright', serif",t.style.whiteSpace="pre-line",t.style.textAlign="center",t.style.color="#fff",t.style.fontSize="clamp(18px, 2.4vw, 30px)",t.style.lineHeight="1.35",t.style.textShadow="0 2px 8px rgba(0,0,0,.55)";let n=t.querySelector("[data-blessing-output]")||t;n.textContent=e.blessing,n.removeAttribute("hidden");let i=t.querySelector("[data-blessing-meta]"),r=t.querySelector("[data-sidthie-title]"),l=t.querySelector("[data-sidthie-excerpt]");if(i){let b=!!e.sidthieLabel,m=!!e.explanation;r&&(b?(r.textContent=e.sidthieLabel,r.removeAttribute("hidden")):r.setAttribute("hidden","hidden")),l&&(m?(l.textContent=e.explanation,l.removeAttribute("hidden")):l.setAttribute("hidden","hidden")),b||m?i.removeAttribute("hidden"):i.setAttribute("hidden","hidden")}let o=t.querySelector("[data-blessing-signup]"),c=t.querySelector("[data-signup-prompt]"),h=t.querySelector("[data-signup-sidthie]"),p=(c==null?void 0:c.getAttribute("data-default-prompt"))||(c==null?void 0:c.textContent)||"";o&&(c&&(p.includes("{sidthie}")?c.textContent=p.replace("{sidthie}",e.sidthieLabel||"your Sidthie"):e.sidthieLabel&&(c.textContent=`${p} (${e.sidthieLabel})`)),h&&(h.value=e.sidthieLabel||""),o.removeAttribute("hidden"),o.style.display=""),setTimeout(()=>{window.dispatchEvent(new CustomEvent("blessing:sync",{detail:{blessing:e.blessing,sidthieLabel:e.sidthieLabel,explanation:e.explanation}}))},100)})}};function X(a){return a.clone().json().catch(()=>({}))}function Z(a){let e=a.headers.get("Content-Type")||a.headers.get("content-type");return e?/ndjson|stream/.test(e):!1}function Q(a){let e={},s=u(a.dataset.apiUrl);s&&(e.apiUrl=s);let t=u(a.dataset.placeholder);t&&(e.placeholder=t);let n=u(a.dataset.loadingText);n&&(e.loadingText=n);let i=K(a.dataset.requireBlessing);return typeof i=="boolean"&&(e.requireBlessing=i),e}function y(a,e){let s=a?document.querySelector(a):document.querySelector("[data-chat-container]");if(!s){console.warn("BlessChat: target container not found.");return}console.info("BlessChat: mounting widget",{selector:a,target:s});let t={...Q(s),...e||{}};new A(s,t).mount()}typeof window!="undefined"&&(window.BlessChat={mount:y},document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>y()):setTimeout(()=>y(),0));return z(ee);})();
