"use strict";var BlessChat=(()=>{var x=Object.defineProperty;var I=Object.getOwnPropertyDescriptor;var _=Object.getOwnPropertyNames;var U=Object.prototype.hasOwnProperty;var P=(r,e)=>{for(var s in e)x(r,s,{get:e[s],enumerable:!0})},$=(r,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of _(e))!U.call(r,i)&&i!==s&&x(r,i,{get:()=>e[i],enumerable:!(t=I(e,i))||t.enumerable});return r};var F=r=>$(x({},"__esModule",{value:!0}),r);var ee={};P(ee,{mount:()=>v});var f={apiUrl:"https://bless-test-brown.vercel.app/api/chat",placeholder:"Talk to Sidthah",sendAriaLabel:"Send message",loadingText:"Listening...",requireBlessing:!0};function p(r){if(r==null)return;let e=r.toString().trim();if(!e)return;let s=e.toLowerCase();if(!(s==="undefined"||s==="null"))return e}function z(r){if(r==null)return;let e=r.toString().trim().toLowerCase();if(!e)return!0;if(["false","0","no","off","disabled"].includes(e))return!1;if(["true","1","yes","on","enabled"].includes(e))return!0}var K=`
:root {
