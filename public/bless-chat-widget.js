"use strict";var BlessChat=(()=>{var b=Object.defineProperty;var L=Object.getOwnPropertyDescriptor;var T=Object.getOwnPropertyNames;var B=Object.prototype.hasOwnProperty;var M=(n,e)=>{for(var t in e)b(n,t,{get:e[t],enumerable:!0})},k=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of T(e))!B.call(n,i)&&i!==t&&b(n,i,{get:()=>e[i],enumerable:!(s=L(e,i))||s.enumerable});return n};var C=n=>k(b({},"__esModule",{value:!0}),n);var F={};M(F,{mount:()=>p});var c={apiUrl:"https://bless-test-brown.vercel.app/api/chat",placeholder:"Talk to Sidthah",sendAriaLabel:"Send message",loadingText:"Listening...",requireBlessing:!0};function l(n){if(n==null)return;let e=n.toString().trim();if(!e)return;let t=e.toLowerCase();if(!(t==="undefined"||t==="null"))return e}var A=`
:root {
...
`,E=document.createElement("style");E.textContent=A;document.head.appendChild(E);function N(){return`<?xml version="1.0" encoding="UTF-8"?>
