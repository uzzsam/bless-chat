"use strict";var BlessChat=(()=>{var x=Object.defineProperty;var U=Object.getOwnPropertyDescriptor;var P=Object.getOwnPropertyNames;var D=Object.prototype.hasOwnProperty;var W=(r,e)=>{for(var s in e)x(r,s,{get:e[s],enumerable:!0})},z=(r,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of P(e))!D.call(r,i)&&i!==s&&x(r,i,{get:()=>e[i],enumerable:!(t=U(e,i))||t.enumerable});return r};var $=r=>z(x({},"__esModule",{value:!0}),r);var ee={};W(ee,{mount:()=>y});var f={apiUrl:"https://bless-test-brown.vercel.app/api/chat",placeholder:"Talk to Sidthah",sendAriaLabel:"Send message",loadingText:"Listening...",requireBlessing:!0};function u(r){if(r==null)return;let e=r.toString().trim();if(!e)return;let s=e.toLowerCase();if(!(s==="undefined"||s==="null"))return e}function K(r){if(r==null)return;let e=r.toString().trim().toLowerCase();if(!e)return!0;if(["false","0","no","off","disabled"].includes(e))return!1;if(["true","1","yes","on","enabled"].includes(e))return!0}var Y=`
:root {
