"use strict";var BlessChat=(()=>{var f=Object.defineProperty;var C=Object.getOwnPropertyDescriptor;var M=Object.getOwnPropertyNames;var A=Object.prototype.hasOwnProperty;var N=(n,e)=>{for(var t in e)f(n,t,{get:e[t],enumerable:!0})},H=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of M(e))!A.call(n,r)&&r!==t&&f(n,r,{get:()=>e[r],enumerable:!(s=C(e,r))||s.enumerable});return n};var R=n=>H(f({},"__esModule",{value:!0}),n);var P={};N(P,{mount:()=>g});var h={apiUrl:"https://bless-test-brown.vercel.app/api/chat",placeholder:"Talk to Sidthah",sendAriaLabel:"Send message",loadingText:"Listening...",requireBlessing:!0};function c(n){if(n==null)return;let e=n.toString().trim();if(!e)return;let t=e.toLowerCase();if(!(t==="undefined"||t==="null"))return e}var D=`
:root {
...
`,S=document.createElement("style");S.textContent=D;document.head.appendChild(S);function O(){return`<?xml version="1.0" encoding="UTF-8"?>
